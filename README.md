<img src="https://github.com/kj-49/trail-volt/blob/main/assets/logo.png?raw=true" alt="menu" height="125"/>

### Status
![workflow](https://github.com/kj-49/trail-volt/actions/workflows/run-tests.yml/badge.svg) 
### Project Description
...
It includes an intelligent battery management system with cell balancing, temperature monitoring, and current sensing for safe and efficient operation. A rotary encoder and OLED screen provide an intuitive user interface, while onboard firmware manages charging, discharging, and fault protection modes.
